function [traj, delta_v] = ...
  capture_hyp_MY(goal_id, orbit, arr_time, park_r, origin_coe, v_in)
...
G = 6.6742e-20; %[km^3/kg/s^2]
    ...
    pl_SOI = (masses(goal_id)/masses(11))^(2/5)...
    ...
    %% Needed variables
    [~, pl_r0, v_arr, ~] =...
        planet_elements_and_svMOD(goal_id, arr_time(1),arr_time(2),...
