function [coe, r, v, jd] = planet_elements_and_svMOD ...
...
% User subfunctions required: planetary_elements
 ...
 masses = 10^24 * [0.330104
    ...
    if((planet_id > 0 && planet_id <= 9) || planet_id == 11)
    ...
    elseif(planet_id < 11)
        ...
        if(planet_id == 10)
            ...
            ut     = (hour + minute/60 + second/3600)/24;
            jd     = j0 + ut;
            [r, v]=enceladus_pos(year, month, day, hour, minute, second);
...
%         %---- a --------- e -------- i -------- RA --------- w_hat ------- L ------
        ...
        0.00159121249    0          0.003       40.586     40.662        240.348
