function [dep_r, dep_v, arr_r, arr_v, flight, orb_oe] = ...
                        gen_orbitMOD(dep_id, arr_id, dep_time, arr_time,flag)
...
%                             month_planet_names
    ...
    %% Computations
    [planet1, planet2, trajectory] = interplanetaryMOD(depart, arrive);
    ...
    %~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    if (flag == 1)
        [mm, ~] = month_planet_namesMOD(depart(3),depart(1));
        pp = 'Dawn';
    else
        [mm, pp] = month_planet_namesMOD(depart(3),depart(1));
    end
    ...
    %~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    if(flag == 2)
        [mm,~] = month_planet_namesMOD(arrive(3),arrive(1));
        pp = 'Dawn';
    else
        [mm,pp] = month_planet_namesMOD(arrive(3),arrive(1));
    end
    fprintf('\n\n Arrival:\n');
    fprintf('\n   Planet: %s', pp);
    fprintf('\n   Year  : %g', arrive(2))
