function [flyby_parameters pos] = flyby_MY(planet_id,delta_ip,altitude,flag,year,month,day,hour,minute,second,alpha_x,beta_y,gamma_z, offset)
global mu
...
[coe, r, v, jd] = planet_elements_and_svMOD(planet_id, year, month, day, hour, minute, second);

% ---------------------------Da riguardare---------------------------
R_sun_planet = sqrt(r*r');
longitude_angle = asin( r(3) / R_sun_planet );
angle_sun_planet = acos( r(1) / (R_sun_planet*cos(longitude_angle)) )+offset;
